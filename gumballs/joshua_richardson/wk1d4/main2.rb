...
case menu_choice
  ...
  when "3"
    ...
    add_buildings.has_doorman = gets.chomp
    puts "Does the building have a doorman? "

      # ternary operator if, else


    add_buildings.has_elevator = gets.chomp
    puts "Does the building have an elevator? "
...
$current_buildings.each {|x| puts x.address}
